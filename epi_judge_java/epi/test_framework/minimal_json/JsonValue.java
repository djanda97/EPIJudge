 ...
 *
 * <p>The literals <strong>true</strong>, <strong>false</strong>, and <strong>null</strong> are
 * represented by the constants {@link #TRUE}, {@link #FALSE}, and {@link #NULL}.
 *
 * <p>JSON <strong>objects</strong> and <strong>arrays</strong> are represented by the subtypes
 * {@link JsonObject} and {@link JsonArray}. Instances of these types can be created using the
 * public constructors of these classes.
 *
 * <p>Instances that represent JSON <strong>numbers</strong>, <strong>strings</strong> and
 * <strong>boolean</strong> values can be created using the static factory methods {@link
 * #valueOf(String)}, {@link #valueOf(long)}, {@link #valueOf(double)}, etc.
 *
 * <p>In order to find out whether an instance of this class is of a certain type, the methods
 * {@link #isObject()}, {@link #isArray()}, {@link #isString()}, {@link #isNumber()} etc. can be
 * used.
 *
 * <p>If the type of a JSON value is known, the methods {@link #asObject()}, {@link #asArray()},
 * {@link #asString()}, {@link #asInt()}, etc. can be used to get this value directly in the
 * appropriate target type.
 *
 * <p>This class is <strong>not supposed to be extended</strong> by clients.
 */
...
public abstract class JsonValue implements Serializable {
   ...
   * exception is thrown.
   *
   * <p>To be interpreted as Java <code>int</code>, the JSON number must neither contain an exponent
   ...
   * @throws NumberFormatException if this JSON number can not be interpreted as <code>int</code>
   *     value
   */
  public int asInt() {
   ...
   * exception is thrown.
   *
   * <p>To be interpreted as Java <code>long</code>, the JSON number must neither contain an
   * exponent nor a fraction part. Moreover, the number must be in the <code>Long</code> range.
   *
   * @return this value as <code>long</code>
   * @throws UnsupportedOperationException if this value is not a JSON number
   * @throws NumberFormatException if this JSON number can not be interpreted as <code>long</code>
   *     value
   */
  public long asLong() {
    throw new UnsupportedOperationException("Not a number: " + toString());
   ...
   *
   * <p>If the JSON number is out of the <code>Float</code> range, {@link Float#POSITIVE_INFINITY}
   * or {@link Float#NEGATIVE_INFINITY} is returned.
   *
   ...
   * JSON number. If this is not the case, an exception is thrown.
   *
   * <p>If the JSON number is out of the <code>Double</code> range, {@link Double#POSITIVE_INFINITY}
   ...
   * @throws UnsupportedOperationException if this value is neither <code>true</code> or <code>false
   *     </code>
   */
   ...
   *
   * <p>Writing performance can be improved by using a {@link java.io.BufferedWriter
   * BufferedWriter}.
   *
   ...
   *
   * @param writer the writer to write this value to
   * @param config a configuration that controls the formatting or <code>null</code> for the minimal
   *     form
   * @throws IOException if an I/O error occurs in the writer
   */
   ...
   *
   * <p>Two JsonValues are considered equal if and only if they represent the same JSON text. As a
