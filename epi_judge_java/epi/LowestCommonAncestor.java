...
public class LowestCommonAncestor {
  ...
  public static int lcaWrapper(
      TimedExecutor executor, BinaryTreeNode<Integer> tree, Integer key0, Integer key1)
      throws Exception {
    ...
    BinaryTreeNode<Integer> result = executor.run(() -> lca(tree, node0, node1));
  ...
  public static void main(String[] args) {
    System.exit(
        GenericTest.runFromAnnotations(
                args, "LowestCommonAncestor.java", new Object() {}.getClass().getEnclosingClass())
            .ordinal());
  }
}
